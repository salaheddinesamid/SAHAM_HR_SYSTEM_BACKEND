...
public class EmployeeDetailsResponseDto {
    ...
    public EmployeeDetailsResponseDto(Employee employee, EmployeeBalance balance) {
        ...
        this.balanceDetails = balance != null ? new BalanceDetails(balance) : null;
    ...
    public EmployeeDetailsResponseDto(Employee employee) {
        this.fullName = String.format("%s %s", employee.getFirstName(), employee.getLastName());
        this.email = employee.getEmail();
        this.entity = employee.getEntity();
        this.joinDate = employee.getJoinDate();
